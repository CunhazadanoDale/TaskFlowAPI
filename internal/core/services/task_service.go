...
func (s *TaskService) CreateTask(ctx context.Context, projectID uuid.UUID, title string, description string, status string) error {
...
func (s *TaskService) UpdateStatus(ctx context.Context, taskID uuid.UUID, newStatus string) error {
